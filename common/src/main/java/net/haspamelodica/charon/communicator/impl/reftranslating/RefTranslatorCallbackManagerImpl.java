...
public abstract class RefTranslatorCallbackManagerImpl<REF_TO, REF_FROM> implements CallbackManager
{
	protected final StudentSideCommunicator<REF_FROM, ?, ?, ?, ?, ?, ?, ? extends InternalCallbackManager<REF_FROM>>	communicator;
	protected final RefTranslator<REF_TO, REF_FROM>																		translator;

	protected RefTranslatorCallbackManagerImpl(StudentSideCommunicator<REF_FROM, ?, ?, ?, ?, ?, ?,
