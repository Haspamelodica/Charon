...
public class RefTranslatorExternalCallbackManagerImpl<REF_TO, REF_FROM, TYPEREF_FROM extends REF_FROM>
		extends RefTranslatorCallbackManagerImpl<REF_TO, REF_FROM, TYPEREF_FROM>
		implements ExternalCallbackManager<REF_TO>
{
	public RefTranslatorExternalCallbackManagerImpl(StudentSideCommunicator<REF_FROM, TYPEREF_FROM, ?,
	...
	public static <REF_TO, REF_FROM, TYPEREF_FROM extends REF_FROM>
			...
			create(StudentSideCommunicator<REF_FROM, TYPEREF_FROM, ?, ? extends InternalCallbackManager<REF_FROM>> communicator,
