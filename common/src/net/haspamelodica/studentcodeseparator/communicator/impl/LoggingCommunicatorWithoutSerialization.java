		...
		COMM extends StudentSideCommunicatorWithoutSerialization<ATTACHMENT, REF>> implements StudentSideCommunicatorWithoutSerialization<ATTACHMENT, REF>
{
	...
	public static <ATTACHMENT, REF extends Ref<ATTACHMENT>> StudentSideCommunicatorWithoutSerialization<ATTACHMENT, REF>
			maybeWrapLoggingW(StudentSideCommunicatorWithoutSerialization<ATTACHMENT, REF> communicator, String prefix, boolean logging)
	{
		if(logging)
	...
	public static <ATTACHMENT, REF extends Ref<ATTACHMENT>> StudentSideCommunicatorWithoutSerialization<ATTACHMENT, REF>
			maybeWrapLoggingW(StudentSideCommunicatorWithoutSerialization<ATTACHMENT, REF> communicator, boolean logging)
	{
		if(logging)
