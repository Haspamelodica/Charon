...
import net.haspamelodica.charon.mockclasses.impl.CloseableMockclassStudentSide;
...
public class SorterExercisePlainJavaManualRunner
{
	public static void main(String[] args) throws IOException, InterruptedException
	{
		...
		try(CloseableMockclassStudentSide closeableStudentSide = new CloseableMockclassStudentSide(SorterExercisePlainJavaManualRunner.class.getClassLoader(),
				interfaceProvider, args, RunnerBodyInterface.class))
		{
			MockclassStudentSide studentSide = closeableStudentSide.getStudentSide();
