...
public interface MarshalingCommunicatorCallbacks<REF, M, SST, SSX extends StudentSideCausedException>
		extends RepresentationObjectMarshaler<REF>, MarshalerCallbacks<SST, SSX>
{
