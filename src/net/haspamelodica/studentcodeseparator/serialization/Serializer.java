...
/**
 * {@link Serializer#serialize(DataOutput, Object)} transmits a snapshot of the object it is passed.
 * Further changes to the original object won't update the object received on the other end.
 * <p>
 * <b> {@link Serializer#deserialize(DataInput)} must always assume read values to be maliciously crafted! </b>
 ...
 * <p>
 * {@link Serializer#deserialize(DataInput)} is recommended to, but not required to, return an immutable object
 * to avoid bugs.
 */
