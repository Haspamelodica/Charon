		...
		implements StudentSideCommunicatorServerSide<REF>
{
	...
	protected LoggingCommunicatorServerSide(Function<LoggingCommunicator<REF, StudentSideCommunicatorServerSide<REF>>,
			StudentSideCommunicatorServerSide<REF>> createCommunicator,
			String prefix)
	{
	...
	{
		logEnter("send with " + serdesRef + " from " + objIn);
	...
	{
		logEnter("receive " + objRef + " with " + serdesRef + " to " + objOut);
			...
			implements RefTranslatorCommunicatorServerSideSupplier
	{
		...
		{
			return new LoggingCommunicatorServerSide<>(comm -> communicatorSupplier.createCommunicator(
